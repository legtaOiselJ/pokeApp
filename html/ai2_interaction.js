...
class PKMN{
  ...
  get_and_set_docElements(){
    ...
    this.divStart = document.getElementById("onStart");
  ...
  run_game(){
    ...
    window.BATTLERS.Wild.run_encounter().then( (wildAsync) => {
      ...
      this.divStart.style.display = "";
      window.BATTLERS.Player.run_encounter();
  ...
  enable_move_panel( enable ){

    this.divStart.style.display = enable ? "none" : "";
    this.beforeMoveDiv.style.display = enable ? "" : "none";
